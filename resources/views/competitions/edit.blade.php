...
@section("content")
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form method="post" action="/competitions/{{ $competition->id }}" enctype="multipart/form-data">
                @method("patch")
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="competition-name" name="title"
                               value="{{ $competition->title }}" placeholder="Sisesta võistluse nimi" required/>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            <input type="text" class="form-control" data-date-start-date="+1d" name="datetime"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="customFile" name="instructions"
                                   accept=".pdf" value="">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="customImage" name="image" accept=".png">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="doubles"
                                   value="option1">
                            <label class="form-check-label"
                                   for="inlineCheckbox1">Paarismänguturniir</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="singles"
                                   value="option2">
                            <label class="form-check-label"
                    ...
                    <div class="col-sm-8">
                        <div class="input-daterange input-group" id="date-range">
                            <input type="text" class="form-control" name="registration_starts"
                                   value="{{ $competition->registration_starts }}" placeholder="Registreerimine algab"/>
                            <div class="input-group-append bg-custom b-0"><span
                                        class="input-group-text"><i
                                            class="mdi mdi-calendar"></i></span></div>
                            <input type="text" class="form-control ml-4" name="registration_ends"
                                   value="{{ $competition->registration_ends }}" placeholder="Registreerimine lõpeb"/>
